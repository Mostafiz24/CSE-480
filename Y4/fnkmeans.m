...
subplot(2,2,4);
 ...
 imtool(imresult,[]);
 imwrite(imresult,'Y4_Kmeans.jpg');
...
nroi_image=simg; 
imwrite(nroi_image,'Y4_Kmeans_NROI.jpg');
logimg=imsubtract(orgimg,simg);
roi_image=logimg;
imwrite(roi_image,'Y4_Kmeans_ROI.jpg');
 subplot(2,1,2);
