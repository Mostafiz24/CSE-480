...
subplot(2,2,4);
 ...
 imtool(imresult,[]);
 imwrite(imresult,'Y50_Kmeans.jpg');
...
nroi_image=simg; 
imwrite(nroi_image,'Y50_Kmeans_NROI.jpg');
logimg=imsubtract(orgimg,simg);
roi_image=logimg;
imwrite(roi_image,'Y50_Kmeans_ROI.jpg');
 subplot(2,1,2);
